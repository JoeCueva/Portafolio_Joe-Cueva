  ...
  projects: Project[] = [
    {
      ...
      images: [
        '/images/vistaEjecutaConstruccion/imagen01.png',
        '/images/vistaEjecutaConstruccion/imagen02.png',
        '/images/vistaEjecutaConstruccion/imagen03.png',
        '/images/vistaEjecutaConstruccion/imagen04.png'
      ],
      currentImageIndex: 0,
      languages: ['HTML5', 'CSS3', 'JavaScript', 'JSX'],
      frameworks: ['React', 'Vite'],
      tools: ['EmailJS', 'Supabase', 'GitHub Actions', 'Figma', 'Visual Studio Code'],
      videoUrl: '/video/proyectoEjecuta.mp4',
    ...
    },
    {
      ...
      images: [
        '/images/vistaBibliotecaMicroservice/imagen1.png',
        '/images/vistaBibliotecaMicroservice/imagen2.png',
        '/images/vistaBibliotecaMicroservice/imagen3.png',
        '/images/vistaBibliotecaMicroservice/imagen4.png',
        '/images/vistaBibliotecaMicroservice/imagen5.png',
        '/images/vistaBibliotecaMicroservice/imagen6.png',
        '/images/vistaBibliotecaMicroservice/imagen7.png',
        '/images/vistaBibliotecaMicroservice/imagen8.png',
        '/images/vistaBibliotecaMicroservice/imagen9.png',
        '/images/vistaBibliotecaMicroservice/imagen10.png',
        '/images/vistaBibliotecaMicroservice/imagen11.png',
        '/images/vistaBibliotecaMicroservice/imagen12.png',
      ],
      currentImageIndex: 0,
      ...
      videoUrl: '/video/proyectoSistemaGestionBiblio.mp4'
    },
    {
      ...
      images: ['/images/vistaBibliotecaMobile/Imagen01.png', '/images/vistaBibliotecaMobile/imagen02.png', '/images/vistaBibliotecaMobile/imagen03.png', '/images/vistaBibliotecaMobile/imagen04.png'],
      currentImageIndex: 0,
